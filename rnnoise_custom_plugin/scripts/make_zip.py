...
def  main():
  ...
  installer = "\installer\rnnoise_custom_plugin Installer.exe"
   
  if demo:
    installer = "\installer\rnnoise_custom_plugin Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\rnnoise_custom_plugin manual.pdf" 
  ]
  ...
  ZIPNAME = "rnnoise_custom_plugin-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "rnnoise_custom_plugin-v" + FULLVERSIONSTR + "-win-demo.zip"

...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=rnnoise_custom_plugin Demo Installer\n"
      else:
        line="OutputBaseFilename=rnnoise_custom_plugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the rnnoise_custom_plugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the rnnoise_custom_plugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=rnnoise_custom_plugin Demo installer\n"
     else:
       line="SetupWindowTitle=rnnoise_custom_plugin installer\n"

...
def main():
  ...
  plistpath = scriptpath + "/resources/rnnoise_custom_plugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/rnnoise_custom_plugin-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/rnnoise_custom_plugin-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/rnnoise_custom_plugin-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/rnnoise_custom_plugin-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/rnnoise_custom_plugin.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/rnnoise_custom_plugin.iss",inplace=1):
